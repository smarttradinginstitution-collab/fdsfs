...
def verify_spider_chart(page: Page):
    """
    Navigates to the dashboard and takes a screenshot of the
    charts grid to verify the new spider chart is present.
    """
    ...
    charts_grid.screenshot(path="jules-scratch/verification/spider_chart.png")
    print("Screenshot saved to jules-scratch/verification/spider_chart.png")
