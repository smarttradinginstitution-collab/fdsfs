...
def verify_new_charts(page: Page):
    """
    Navigates to the dashboard and takes a screenshot of the
    charts grid to verify the new charts are present.
    """
    ...
    charts_grid.screenshot(path="jules-scratch/verification/new_charts.png")
    print("Screenshot saved to jules-scratch/verification/new_charts.png")
