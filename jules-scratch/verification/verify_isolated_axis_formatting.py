...
def verify_axis_formatting(page: Page):
    ...
    P&L chart to verify the final axis formatting.
    """
    ...
    chart_widget.screenshot(path="jules-scratch/verification/final_isolated_axis_formatting.png")
    print("Screenshot saved to jules-scratch/verification/final_isolated_axis_formatting.png")
