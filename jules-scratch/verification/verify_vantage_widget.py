...
def verify_vantage_widget(page: Page):
    ...
    charts grid to verify the new Vantage Score widget.
    """
    ...
    charts_grid.screenshot(path="jules-scratch/verification/vantage_widget.png")
    print("Screenshot saved to jules-scratch/verification/vantage_widget.png")
