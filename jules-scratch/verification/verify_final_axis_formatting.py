...
def verify_axis_formatting(page: Page):
    ...
    chart_widget.screenshot(path="jules-scratch/verification/final_axis_formatting.png")
    print("Screenshot saved to jules-scratch/verification/final_axis_formatting.png")
