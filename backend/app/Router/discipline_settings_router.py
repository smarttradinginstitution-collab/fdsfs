...
from app.Schemas.discipline_settings_schema import DisciplineSettingsRead, DisciplineSettingsUpdate
...
@router.get("", response_model=DisciplineSettingsRead)
...
@router.post("", response_model=DisciplineSettingsRead)
