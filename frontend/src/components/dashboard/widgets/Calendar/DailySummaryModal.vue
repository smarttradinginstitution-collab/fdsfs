...
<template>
  ...
  >
    <template #header>
      <!-- Aggiunto controllo per summaryData.stats -->
    ...
    <template #default>
      ...
      <!-- Aggiunto controllo per summaryData.stats e summaryData.error -->
      ...
      <div v-else class="loading-state">No trades for this day.</div>
    </template>
