      ...
      <template #item="{ element: group }">
        <div class="condition-group">
          <div class="group-header">
            ...
            <input v-model="group.name" @blur="saveContent" class="input-ghost group-title-input" />
          </div>
            ...
            <template #item="{ element: item }">
              <div class="list-item">
                  ...
                  <div v-if="item.type === 'CHECKLIST'" class="checklist-text">
                        ...
                        <input v-model="item.data.text" @blur="saveContent" class="input-ghost checklist-input" />
                  </div>
...
.condition-group {
  /* No background, no border. Defined by space. */
  padding: 0;
  margin: 0;
}
.group-header {
